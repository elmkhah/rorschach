...
| **مرحله‌ی روشن‌سازی (CP)**    | برای هر پاسخ: کارت + متن خود فرد، کشیدن کادر دور ناحیه‌ای که آن را در آن دیده (یا «کل تصویر») و پاسخ به «چه چیزی باعث شد این‌طور به نظر برسد؟» با انتخاب از فهرست دلایل و توضیح اختیاری |
