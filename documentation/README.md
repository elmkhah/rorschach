...
| ۰۳ | [[03-data-model-er]] | ERD واقعی + schema کامل هر ۲۰ جدول (ستون، نوع، constraint، index) |
| ۰۴ | [[04-api-design]] | مرجع کامل API: هر ۴۹ مسیر، دسترسی، بدنه‌ی درخواست و پاسخ، کدهای خطا |
...
| ۱۲ | [[12-testing-and-quality]] | راهبرد تست، ۱۲۹ تست و نگاشت آن‌ها به نیازمندی‌ها، کیفیت کد |
